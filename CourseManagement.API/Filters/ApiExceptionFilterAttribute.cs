...
namespace CourseManagement.API.Filters
{
    public class ApiExceptionFilterAttribute : ExceptionFilterAttribute
    {
        ...
        public ApiExceptionFilterAttribute()
        {
            ...
            {
                { typeof(DomainLayerException), HandleApplicationException },
                { typeof(ApplicationLayerException), HandleApplicationException },
        ...
        {
            var exception = context.Exception as CourseManagementException;

            var details = new ProblemDetails()
            {
                Title = "Unable to proccess your request.",
                Detail = exception.Message
            };
